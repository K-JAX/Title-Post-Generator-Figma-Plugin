...
// set the scene
let stageFrame = figma.createFrame(),
    igFrame = figma.createFrame(),
    fbLiFrame = figma.createFrame(),
    gradient = figma.createRectangle(),
    title = figma.createText(),
    titleComponent = figma.createComponent();
